...
data class CellSelection(val editor: FrontendEditorComponent, val cell: Cell, val directionLeft: Boolean, val previousSelection: Selection?) : Selection() {
    ...
    override fun update(editor: FrontendEditorComponent): Selection? {
        return cell.cellReferences.asSequence()
