...
interface IReactPageDescriptor {
    ...
    fun getRoot(
        repository: IReadableNode,
        pathParameterValues: Map<String, String>,
    ): RendererCall
}

class PagePath(
    val parts: List<PagePathPart>,
) {
...
sealed class PagePathPart {
    abstract fun matches(
        actualPart: String,
        assignedValues: MutableMap<String, String>,
    ): Boolean
}

data class StaticPagePathPart(
    val value: String,
) : PagePathPart() {
    ...
    override fun matches(
        actualPart: String,
        assignedValues: MutableMap<String, String>,
    ): Boolean = value == actualPart
}

data class VariablePagePathPart(
    val name: String,
) : PagePathPart() {
